...
const PageFormRecord = (props: {
    recordType: RecordTypeEnum,
    formMode: 'PREVIEW' | 'NORMAL' | 'READONLY',
    layout: 'DRAFT' | 'ACTIVE'
}) => {
        ...
        <Container>
            {
                query.data != null ?
                    <HypeFormContext.Provider value={{
                        ...
                        <div className={'page-card'}>
                            ...
                            <div className={'d-flex mb-5'}>
                                <div
                                    className={'d-inline-flex ms-1 fs-1'}> {query.data?.name} {props.formMode == 'PREVIEW' ? '[PREVIEW]' : ''}</div>
                                Form
                            </div>
                    ...
                    : <PageCard>
                        <LoadingBar text={'Fetching form data'}/>
                    </PageCard>
            }
